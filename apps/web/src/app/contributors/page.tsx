...
export const metadata: Metadata = {
	title: "Contributors - VariantLab",
	description:
		"Meet the amazing people who contribute to VariantLab, the free and open-source video editor.",
	openGraph: {
		title: "Contributors - VariantLab",
		description:
			"Meet the amazing people who contribute to VariantLab, the free and open-source video editor.",
...
export default async function ContributorsPage() {
	...
	return (
		<BasePage
			title="Contributors"
			description="Meet the amazing people who contribute to VariantLab, the free and open-source video editor."
		>
			...
			<div className="mx-auto flex max-w-6xl flex-col gap-20">
				...
				<GitHubContributeSection
					...
					description="VariantLab is built by developers like you. Every contribution, no matter how small, helps make video editing more accessible for everyone."
				/>
			</div>
		</BasePage>
	);
	...
	return (
		<div className="flex flex-col gap-12">
			<div className="flex flex-col gap-2 text-center">
				...
				<p className="text-muted-foreground">
					Everyone who makes VariantLab better
				</p>
			</div>
	...
	return (
		<div className="flex flex-col gap-10">
			<div className="flex flex-col gap-2 text-center">
				...
				<p className="text-muted-foreground">Tools we use to build VariantLab</p>
			</div>
