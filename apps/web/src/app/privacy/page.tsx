...
export const metadata: Metadata = {
	title: "Privacy Policy - VariantLab",
	description:
		"Learn how VariantLab handles your data and privacy. Our commitment to protecting your information while you edit videos.",
	openGraph: {
		title: "Privacy Policy - VariantLab",
		description:
			"Learn how VariantLab handles your data and privacy. Our commitment to protecting your information while you edit videos.",
	...
	return (
		...
		>
				...
				>
					...
					<AccordionContent>
						...
						<ol className="list-decimal space-y-2 pl-6">
							...
							<li>
								VariantLab does not currently require an account or login
							</li>
			...
			<section className="flex flex-col gap-3">
				...
				<p>
					VariantLab does not currently offer user accounts, login, or Google
					sign-in.
				</p>
				<p>
			...
			<section className="flex flex-col gap-3">
				...
				<p>VariantLab integrates with these services:</p>
				<ul className="list-disc space-y-2 pl-6">
					<li>
			...
			<section className="flex flex-col gap-3">
				...
				<ul className="list-disc space-y-2 pl-6">
					<li>No account is required to use VariantLab today</li>
			...
			<section className="flex flex-col gap-3">
				...
				<p>
					VariantLab is completely open source. You can review our code, see
