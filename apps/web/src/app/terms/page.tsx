...
export const metadata: Metadata = {
	title: "Terms of Service - VariantLab",
	description:
		"VariantLab's Terms of Service. Fair, transparent terms for our free and open-source video editor.",
	openGraph: {
		title: "Terms of Service - VariantLab",
		description:
			"VariantLab's Terms of Service. Fair, transparent terms for our free and open-source video editor.",
		...
		>
			...
			<section className="flex flex-col gap-3">
				...
				<ul className="list-disc space-y-2 pl-6">
					...
					<li>No watermarks, no licensing restrictions from VariantLab</li>
				</ul>
			</section>

			<section className="flex flex-col gap-3">
				<h2 className="text-2xl font-semibold">How You Can Use VariantLab</h2>
				<p>VariantLab is free for personal and commercial use. You can:</p>
				<ul className="list-disc space-y-2 pl-6">
					<li>
						Create videos for personal, educational, or commercial purposes
					</li>
					<li>Use VariantLab for client work and paid projects</li>
					<li>Share and distribute videos created with VariantLab</li>
					<li>
						Modify and distribute the VariantLab software (under MIT license)
					</li>
				</ul>
				<p>
					You&apos;re responsible for how you use VariantLab and the content you
			...
			<section className="flex flex-col gap-3">
				...
				<p>
					...
					are optional - you can use VariantLab without them.
				</p>
			</section>
			...
			<section className="flex flex-col gap-3">
				...
				<p>
					VariantLab does not currently require an account. The service is provided
			...
			<section className="flex flex-col gap-3">
				...
				<p>Because VariantLab is open source, you have additional rights:</p>
				<ul className="list-disc space-y-2 pl-6">
					<li>Review our code to see exactly how we handle your data</li>
					<li>Self-host VariantLab on your own servers</li>
			...
			<section className="flex flex-col gap-3">
				...
				<p>
					VariantLab is provided free of charge. To the extent permitted by law:
				</p>
				<ul className="list-disc space-y-2 pl-6">
			...
			<section className="flex flex-col gap-3">
				...
				<p>We may update VariantLab and these terms:</p>
				<ul className="list-disc space-y-2 pl-6">
			...
			<section className="flex flex-col gap-3">
				...
				<p>You can stop using VariantLab at any time:</p>
				<ul className="list-disc space-y-2 pl-6">
