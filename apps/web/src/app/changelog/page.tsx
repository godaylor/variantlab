...
export const metadata: Metadata = {
	title: "Changelog - VariantLab",
	description: "What's new in VariantLab",
	openGraph: {
		title: "Changelog - VariantLab",
		description: "Every update, improvement, and fix to VariantLab — documented.",
		type: "website",
		images: [
			{
...
export default function ChangelogPage() {
	...
	return (
		<BasePage title="Changelog" description="See what's new in VariantLab">
